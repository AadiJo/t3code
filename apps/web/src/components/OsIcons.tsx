...
/**
 * OS logos from svgl (https://svgl.app), used to mark which platform a remote
 * environment runs on. Apple ships fill-less (it would render black on a dark
 * background), so it is pinned to currentColor; Windows and Tux keep their
 * brand colours because Tux is only legible in colour.
 */
...
/** Tux carries 21 gradient/filter ids; useId keeps them unique per instance. */
export const LinuxIcon: Icon = (props) => {
  const id = useId().replaceAll(":", "");
  const ids = Array.from({ length: 21 }, (_, index) => `${id}-tux-${index}`);

  return (
    <svg {...props} viewBox="0 0 256 295">
      <defs>
        <linearGradient id={ids[0]} x1="48.548%" x2="51.047%" y1="115.276%" y2="41.364%">
          <stop offset="0%" stopColor="#FFEED7" />
          <stop offset="100%" stopColor="#BDBFC2" />
        </linearGradient>
        <linearGradient id={ids[1]} x1="54.407%" x2="46.175%" y1="2.404%" y2="90.542%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".8" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[2]} x1="51.86%" x2="47.947%" y1="88.248%" y2="9.748%">
          <stop offset="0%" stopColor="#FFEED7" />
          <stop offset="100%" stopColor="#BDBFC2" />
        </linearGradient>
        <linearGradient id={ids[3]} x1="49.925%" x2="49.924%" y1="85.49%" y2="13.811%">
          <stop offset="0%" stopColor="#FFEED7" />
          <stop offset="100%" stopColor="#BDBFC2" />
        </linearGradient>
        <linearGradient id={ids[4]} x1="53.901%" x2="45.956%" y1="3.102%" y2="93.895%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[5]} x1="45.593%" x2="54.811%" y1="5.475%" y2="93.524%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[6]} x1="49.984%" x2="49.984%" y1="89.845%" y2="40.632%">
          <stop offset="0%" stopColor="#FFEED7" />
          <stop offset="100%" stopColor="#BDBFC2" />
        </linearGradient>
        <linearGradient id={ids[7]} x1="53.505%" x2="42.746%" y1="99.975%" y2="23.545%">
          <stop offset="0%" stopColor="#FFEED7" />
          <stop offset="100%" stopColor="#BDBFC2" />
        </linearGradient>
        <linearGradient id={ids[8]} x1="49.841%" x2="50.241%" y1="13.229%" y2="94.673%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".8" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[9]} x1="49.927%" x2="50.727%" y1="37.327%" y2="92.782%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[10]} x1="49.876%" x2="49.876%" y1="2.299%" y2="81.204%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[11]} x1="49.833%" x2="49.824%" y1="2.272%" y2="71.799%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[12]} x1="53.467%" x2="38.949%" y1="48.921%" y2="98.1%">
          <stop offset="0%" stopColor="#FFA63F" />
          <stop offset="100%" stopColor="#FF0" />
        </linearGradient>
        <linearGradient id={ids[13]} x1="52.373%" x2="47.579%" y1="143.009%" y2="-64.622%">
          <stop offset="0%" stopColor="#FFEED7" />
          <stop offset="100%" stopColor="#BDBFC2" />
        </linearGradient>
        <linearGradient id={ids[14]} x1="30.581%" x2="65.887%" y1="34.024%" y2="89.175%">
          <stop offset="0%" stopColor="#FFA63F" />
          <stop offset="100%" stopColor="#FF0" />
        </linearGradient>
        <linearGradient id={ids[15]} x1="59.572%" x2="48.361%" y1="-17.216%" y2="66.118%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[16]} x1="47.769%" x2="51.373%" y1="1.565%" y2="104.313%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[17]} x1="43.55%" x2="57.114%" y1="4.533%" y2="92.827%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <linearGradient id={ids[18]} x1="49.733%" x2="50.558%" y1="17.609%" y2="99.385%">
          <stop offset="0%" stopColor="#FFA63F" />
          <stop offset="100%" stopColor="#FF0" />
        </linearGradient>
        <linearGradient id={ids[19]} x1="50.17%" x2="49.68%" y1="2.89%" y2="94.17%">
          <stop offset="0%" stopColor="#FFF" stopOpacity=".65" />
          <stop offset="100%" stopColor="#FFF" stopOpacity="0" />
        </linearGradient>
        <filter
